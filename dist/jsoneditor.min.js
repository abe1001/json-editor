...
this.options.input_event&&this.input.addEventListener(this.options.input_event,e),this.options.input_height&&(this.input.style.height=this.options.input_height),this.options.expand_height&&(this.adjust_height=function(a){if(a){var b,c=a.offsetHeight;
// Input too short
...
c.on("change",function(){b.trigger("change")}),c.on("ready",function(){b.trigger("ready")}))}return this}}}(),/*global module*/
"undefined"!=typeof module&&module.exports&&(module.exports=f),"undefined"!=typeof window&&(window.JSONEditor=f)}();
